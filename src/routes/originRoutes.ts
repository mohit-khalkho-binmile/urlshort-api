 ...
 *
 */
router.post('/create/origin',createOrigin);
/**
 * @swagger
 * /edit/origin:
 *  put:
 ...
 *
 */
router.put('/edit/origin',editOrigin);
// /**
//  * @swagger
//  * /delete-origin/{id}:
//  *  delete:
...
//  */
router.delete('/delete-origin/:id',deleteOrigin);
/**
 * @swagger
 * /delete-origin:
 *  post:
 ...
 *        description: Record deleted Succesfully
 */
router.post('/delete-origin',deleteorigin);
/**
 * @swagger
 * /get/origins:
 *  get:
